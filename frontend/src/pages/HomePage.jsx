...
const HomePage = () => {
 ...
 <div className="text-center">
   <div className="inline-block w-full sm:w-auto bg-white text-[#0A2540] px-7 py-8 sm:py-3.5 rounded-2xl sm:rounded-xl text-[2rem] sm:text-[2rem] font-black tracking-tight sm:leading-tight mb-2 sm:mb-6 inline-badge hero-title-badge font-ghayaty transform-none shadow-[0_6px_18px_rgba(0,0,0,0.06)] ring-1 ring-black/5 min-h-[90px] sm:min-h-0"
        style={{
          width: '100%',
          height: 'auto',
          display: 'flex',
